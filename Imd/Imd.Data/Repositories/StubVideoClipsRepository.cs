        ...
        private static IList<VideoClip> Seed()
        {
            return new List<VideoClip>
            {
                new VideoClip
                {
                    ...
                    Start = new TimeCode(00,00,00,00),
                    End = new TimeCode(00,00,30,12)
                },
                new VideoClip
                {
                    Id = Guid.NewGuid(),
